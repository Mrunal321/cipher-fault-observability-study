...
substantially even when the realized Boolean function and the
output-driving layer have not become more fault resistant.
...
\begin{itemize}
  ...
  \item As a granularity control, we measure target-layer \AvgDP{}
        ...
        interpretation that the all-site difference comes from the mix of
        interior gate sites, not from any change in the output-driving
        layer.
