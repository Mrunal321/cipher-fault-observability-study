...
Table~\ref{tab:masking-trace} summarizes the exhaustive trace.

\input{../mechanism_example/figure_masking}
\input{../mechanism_example/table_trace}
...
the synthesized netlists, the fault simulator, generated tables and
figures, and a verification script that checks the quoted summary numbers
against the raw JSON outputs.
